...
def get_data(symbols):
    """
    :return: Download Historical Stock Data
    """
...
def stock_stats(stock_data):
    """
    :return: Mean Daily Return and Variance for given stocks
    """
...
def calc_returns_stats(stock_data):
    """
    :return: Mean Daily Returns and Covariance Matrix for given stocks
    """
...
def portfolio_stats(mean_ret, cov_mat, weights):
    """
    :return: Mean Daily Return and Variance of a Portfolio comprised of stocks with given weightings
    """
